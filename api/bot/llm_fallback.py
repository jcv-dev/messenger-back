...
_STATE_OPTIONS: dict[str, list[dict]] = {
    "WELCOME": [
        ...
        {"id": "pedido", "label": "Preguntar sobre pedido / estado pedido / consultar pedido / mi pedido / quiero saber de mi pedido / información de pedido / solicitud / orden / seguimiento de pedido / cómo va mi pedido / dónde está mi pedido / rastrear pedido / ver pedido"},
